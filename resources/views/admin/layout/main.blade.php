...
<div class="page-header navbar navbar-fixed-top">
	...
	<div class="page-header-inner">
		...
		<div class="page-logo">
			<a href="index.html">
			<img src="{{asset("admin/assets/admin/layout4/img/logo-light.png")}}" alt="logo" class="logo-default"/>
			</a>
							...
							<li>
								<ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
									...
									<li>
										<a href="inbox.html?a=view">
										<span class="photo">
										<img src="{{asset("admin/assets/admin/layout3/img/avatar1.jpg")}}" class="img-circle" alt="">
										</span>
										<span class="subject">
										<span class="from">
										Bob Nilson </span>
...
<div class="page-footer">
	<div class="page-footer-inner">
		2017 &copy; <a href="javascript:;" target="_blank">TATeam</a>
	</div>
...
<!-- IMPORTAN{{ asset('') }} endar depends on jquery-ui.min.js for drag & drop support -->
...
<script src="{{ asset('admin/assets/admin/layout2/scripts/quick-sidebar.js') }} " type="text/javascript"></script>
